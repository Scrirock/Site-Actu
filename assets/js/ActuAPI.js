        ...
        .then(response => {
            ...
            for (let i = 0; i < apiResponse.length; i++){
                ...
                article.addEventListener("click", ()=>{
                    ...
                    if (allArticle[1].style.display !== "none" || allArticle[8].style.display !== "none"){
                        article.style.cursor = "initial";
                        for (let i = 0; i < 20; i++) {
                            if (allArticle[i] !== article) {
                                allArticle[i].style.display = "none";
                            } else {
                                let backup = addLorem(description);
